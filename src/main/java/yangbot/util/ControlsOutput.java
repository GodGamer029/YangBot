...
public class ControlsOutput implements ControllerState {
    ...
    public void set(ControlsOutput other){
        this.steer = other.getSteer();
        this.pitch = other.getPitch();
        this.yaw = other.getYaw();
        this.roll = other.getRoll();
        this.throttle = other.getThrottle();
        this.jumpDepressed = other.holdJump();
        this.boostDepressed = other.holdBoost();
        this.slideDepressed = other.holdHandbrake();
        this.useItemDepressed = other.holdUseItem();
    }
